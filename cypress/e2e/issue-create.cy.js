...
Test 1
*/
  it('Create an issue of type Bug and validate it successfully', () => {
    //System finds modal for creating issue and does next steps inside of it
    cy.get('[data-testid="modal:issue-create"]').within(() => {
...
*/
  ...
  const myTitle = faker.animal.bird();
  
  it('Create an issue of type Task and validate it successfully', () => {
